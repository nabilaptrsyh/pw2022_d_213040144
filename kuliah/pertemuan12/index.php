    ...
    <div class="container">
      ...
      <form action="" method="get" class="mt-4">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="keyword" placeholder="Apa yang mau kamu cari?" autocomplete="off">
...
$no = 1;
    ...
    <tr>
      ...
      <td class="align-middle">
        <img src="img/<?php echo $mhs ["gambar"]?>" height="80" class="rounded-circle">
      </td>
