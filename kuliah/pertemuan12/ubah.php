      ...
      <div class="row mt-3">
          <div class="col-8">
              <form action="" method="post">
                  ...
                  <!-- kalau NPM gamau diubah, kasih tulisan readonly -->
                  <form action="" method="post">
                  <div class="mb-3">
                      <label for="npm" class="form-label">NPM</label>
                      <input type="number" class="form-control" id="npm" name="npm" maxlength="9" style="width:120px" required value="<?= $mhs["npm"]; ?>" readonly>
                  </div>
                  <form action="" method="post">
                  <div class="mb-3">
